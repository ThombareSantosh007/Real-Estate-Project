        ...
        <div className="mt-16 grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8 space-y-12">
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900">West Coast Office</h3>
                <div className="mt-2 text-base text-gray-500">
                  <p>456 Ocean Avenue</p>
                  <p>San Francisco, CA 94111</p>
                  <p className="mt-2">Phone: (987) 654-3210</p>
                  <p>Email: westcoast@mahavastu.com</p>
                </div>
              </div>
